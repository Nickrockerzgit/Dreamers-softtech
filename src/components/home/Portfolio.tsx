      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-stretch">
          ...
          >
            <div className="grid grid-cols-3 gap-3 h-[480px]">
              {visibleProjects.map((project, i) => (
                <div
                  key={`${project.title}-${activeIndex}-${i}`}
          ...
          <div className="lg:w-[38%] flex flex-col justify-center">
            ...
            {/* CTA */}
            <button className="self-start inline-flex items-center gap-2 bg-[#C89A3D] hover:bg-[#b78930] text-white font-semibold px-6 py-3 rounded-xl transition-all duration-200 shadow hover:shadow-lg text-sm">
              View All Projects
